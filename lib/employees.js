...
const viewEmployees = function () {
    ...
    // By using LEFT OUTER JOIN on the last two lines of the sql command, when the department is deleted, the employee will still be shown, with null as the value for department
    // the same will apply for the roles if they are deleted
    const sql = `
